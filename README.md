...
<h1>
  <img src="https://raw.githubusercontent.com/YunoHost/apps/main/logos/rustfs.png" width="32px" alt="Logo of RustFS">
  RustFS, packaged for YunoHost
</h1>
...
<div align="center">
<a href="https://apps.yunohost.org/app/rustfs"><img height="100px" src="https://github.com/YunoHost/yunohost-artwork/raw/refs/heads/main/badges/neopossum-badges/badge_more_info_on_the_appstore.svg"/></a>
...
🛠️ Upstream RustFS repository: <https://github.com/rustfs/rustfs>

Pull request are welcome and should target the [`testing` branch](https://github.com/YunoHost-Apps/rustfs_ynh/tree/testing).

The `testing` branch can be tested using:
```
# fresh install:
sudo yunohost app install https://github.com/YunoHost-Apps/rustfs_ynh/tree/testing

# upgrade an existing install:
sudo yunohost app upgrade rustfs -u https://github.com/YunoHost-Apps/rustfs_ynh/tree/testing
```
